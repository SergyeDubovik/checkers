...
public class HumanPlayer extends Player {
    ...
    public Board getMove(Board board) {
        ...
        while (true) {
            ...
            // check that there are some, and if so, continue to ask for a move
        ...
        for (int y = -1; y < board.size; y++) {
            ...
            for (int x = -1; x < board.size; x++) {
                ...
                // add an exception for the left column (print number coordinates)
                    ...
                    // get a piece here (possibly null)
    ...
    private Piece getPieceFromUser(Board board) {
        // keep trying again until we get a valid piece chosen
        while (true) {
            String raw;
     ...
     * @return The Move object representing the chosen move (can be null if the user chooses to get a new piece)
     */
